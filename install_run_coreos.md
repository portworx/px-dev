## Installing and Running PX-Dev on CoreOS
...
## Prerequisites 
PX-Dev requires a server with storage devices, Docker 1.10, and use of a key-value store for the cluster configuration. This guide uses CoreOS (1010.6.0 minimum) as the OS. 


### Step 1: Launch servers
First, we create three servers in AWS, using: 
* Image: [CoreOS (HVM)](https://console.aws.amazon.com/ec2/home?region=us-east-1#launchAmi=ami-9327e9fe)
...
* Configure Docker to use shared mounts.
 - Copy docker.service file for editing
   ...
   - Edit the docker service file for systemd.
...
The definition for all attributes in config.json is [here] (https://github.com/portworx/px-dev/tree/master/conf) 
